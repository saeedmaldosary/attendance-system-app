...
import com.example.StudentsAttendanceSystemFacialRecognition.components.BitmapUtils;
import com.example.StudentsAttendanceSystemFacialRecognition.components.FrameMetadata;
import com.example.StudentsAttendanceSystemFacialRecognition.components.GraphicOverlay;
import com.example.StudentsAttendanceSystemFacialRecognition.components.VisionImageProcessor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    public synchronized void process(
            ByteBuffer dataB, final FrameMetadata fMetadata, final GraphicOverlay
            gOverlay) {
        latestImage = dataB;
        latestImageMetaData = fMetadata;
        if (processingImage == null && processingMetaData == null) {
            processLatestImage(gOverlay);
        }
    }
