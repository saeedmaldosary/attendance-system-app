...
public class NamesNotDetectedAdapter extends RecyclerView.Adapter<NamesNotDetectedAdapter.ViewHolder> {
    ...
    public NamesNotDetectedAdapter(Context context, ArrayList<String> data, ArrayList<String> data2) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.checkBoxName.setChecked(false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        DetectedNames detectedNames2 = new DetectedNames();
